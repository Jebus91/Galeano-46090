 ...
 *
 * Created on July 10, 2015, 10:30 PM
 * Purpose: home work
 */
...
//function prototypes
float inflation(float inflation, float);
float futureinf(float, float);
...
float futureinf( float inflation, float priceT){
